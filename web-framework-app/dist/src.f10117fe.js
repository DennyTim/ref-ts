...
function () {
  function Attributes(data) {
    ...
    this.data = data; //принимает ключ К, который является ключем обьекта T
...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    var id = data.id;
    return id ? axios_1.default.put(this.rootUrl + "/" + id, data) : axios_1.default.post(this.rootUrl, data);
  };
...
function (_super) {
  ...
  User.buildUserCollecion = function () {
...
// }
},{"./models/User":"src/models/User.ts","./models/Collection":"src/models/Collection.ts","./views/UserList":"src/views/UserList.ts"}],"C:/Users/Lucky/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "32133" + '/');
...
},{}]},{},["C:/Users/Lucky/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
